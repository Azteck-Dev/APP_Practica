...
class DAOAPP:
    ...
    # Encrytado del password ante del ingreso a la db.
    @classmethod
    def encryp_pass(cls, password):
        """Recibe la propiedad con el password del usuario y lo convierte a un objeto encriptado con md5

        Args:
            password (property): Propiedad del usuario con el valor del password

        Returns:
            str: pass encriptada con md5
    ...
    # Tratameinto de los datos y ingreso de los mismos a la base de datos.
    @classmethod
    def mk_reg(cls, user: Users):
        """Recibe el objeto de clase usuario y obtiene los atributos necesarios para la creacion
    ...
    # Actualizacion de datos de un registro en la base de datos.
    @classmethod
